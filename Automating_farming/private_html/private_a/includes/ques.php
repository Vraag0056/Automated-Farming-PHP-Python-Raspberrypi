...
if(isset($_POST["start_pipe1"])) {
  ...
  $pipe1_time=0;
          $sql = "UPDATE `pesticide` SET `pipe1`='$pipe1',`time_pipe1`='$pipe1_time' WHERE `id`=1";
          ...
          if(isset($_POST["stop_pipe1"])) {
              ...
              $pipe1_time=0;
                      ...
                      if(isset($_POST["start_pipe2"])) {
                          ...
                          $pipe2_time=0;
                                  $sql = "UPDATE `pesticide` SET `pipe2`='$pipe2',`time_pipe2`='$pipe2_time' WHERE `id`=1";
                                  $stmt = $conn->prepare($sql);
                                   if($stmt->execute()){
                                      $resMessage = array(
                                          "status" => "alert-success",
    ...
    <!-- Content Header (Page header) -->
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Pesticide</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<br>
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <lable>Status:<?php 
                  $conn = new mysqli('localhost', 'root', 'root', 'farming');
                   $sql1 = "SELECT pipe2 FROM pesticide WHERE id='1'";
                   $result=mysqli_query($conn,$sql1);
